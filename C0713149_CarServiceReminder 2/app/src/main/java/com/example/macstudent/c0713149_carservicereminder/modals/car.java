package com.example.macstudent.c0713149_carservicereminder.modals;
...
public class car {
    ...
    public car(int id, String serviceDate, String odometer, String cost, String nextService, String nextChange, String serviceStationName) {
        this.id = id;
